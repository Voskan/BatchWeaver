...
- The adapter verification harness is reused for protocols, comparing scalar and batch behavior (values, errors, correlation, missing/duplicate) over hermetic httptest/in-memory fixtures and emitting a deterministic contract artifact.
