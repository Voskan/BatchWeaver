...
Required: Go 1.26.5. VS Code packaging uses Node 22, npm 10, and the committed
lockfile. Release binaries require no
native dependency because CGO is disabled.
...
vendored or fully air-gapped npm build has not been tested. Runtime, compiler,
