...
func TestSchemaCompatibility(t *testing.T) {
	manifest := Manifest{Schema: ManifestSchema, Version: "0.1.0-rc.1", Snapshot: true, Publication: "disabled", Commit: strings.Repeat("a", 40), Artifacts: []Artifact{{Path: "x", Kind: "test", Size: 1, Digest: Digest{Algorithm: "sha256", Value: strings.Repeat("0", 64)}}}}
...
func FuzzManifest(f *testing.F) {
	seed := Manifest{Schema: ManifestSchema, Version: "0.1.0-rc.1", Snapshot: true, Publication: "disabled", Commit: strings.Repeat("a", 40), Artifacts: []Artifact{{Path: "x", Kind: "test", Size: 1, Digest: Digest{Algorithm: "sha256", Value: strings.Repeat("0", 64)}}}}
...
func TestDocumentation(t *testing.T) {
	...
	for _, required := range []string{"docs/release/release-policy.md", "docs/release/readiness-report.md", "docs/release/compatibility.md", "docs/release/security-report.md", "docs/release/performance-report.md", "docs/release/reproducibility-report.md", "docs/release/release-checklist.md", "docs/release/rollback.md", "KNOWN-ISSUES.md"} {
