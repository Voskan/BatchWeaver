...
// path: consuming Prompt 05 proof certificates, planning deterministic
...
// versioned transformation IR that references stable Prompt 04 identities and
// Prompt 05 certificates and never serializes AST nodes, SSA values, token
